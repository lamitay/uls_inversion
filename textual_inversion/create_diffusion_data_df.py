...
def create_data_df(images_base_dir, diff_model_name):
    ...
    images_dir = os.path.join(images_base_dir, 'samples')
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--images_base_dir", default='/Users/amitaylev/Desktop/Amitay/Msc/4th semester/ML4Health/Final project/ddpm_experiments/inference_1000_samples_ddpm-viral_3_mix_images_uls-128_3000_epochs_23_09_2023-13_56_11', help="Path to the directory containing the images.")
    # parser.add_argument("--diff_model_name", default="ddpm-viral_3_mix_images_uls-128_3000_epochs", help="Name of the diffusion model used to generate the current dataset.")
    parser.add_argument("--images_base_dir", default='/Users/amitaylev/Desktop/Amitay/Msc/4th semester/ML4Health/Final project/ddpm_experiments/inference_1000_samples_ddpm-viral_uls-128_2000_epochs_23_09_2023-13_56_04', help="Path to the directory containing the images.")
    parser.add_argument("--diff_model_name", default="ddpm-ddpm-viral_uls-128_2000_epochs", help="Name of the diffusion model used to generate the current dataset.")
    ...
    # Save df
    output_path = os.path.join(args.images_base_dir, f'synthetic_viral_uls_data_{args.diff_model_name}.csv')
